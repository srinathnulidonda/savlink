    ...
    <section className="rounded-xl border border-gray-800/50 bg-gray-900/20 overflow-hidden">
      ...
      {collections.length === 0 ? (
        <div className="px-5 py-12 text-center">
          ...
          <p className="text-[13px] text-gray-400 mb-0.5">No folders</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-gray-800/20">
          {collections.slice(0, 6).map((col, i) => (
            <motion.button key={col.id}
              ...
              <svg className="w-3.5 h-3.5 text-gray-800 group-hover:text-gray-500 -translate-x-1 group-hover:translate-x-0 opacity-0 group-hover:opacity-100 transition-all flex-shrink-0"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
              </svg>
            </motion.button>
