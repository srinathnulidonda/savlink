...
export default function Login() {
    ...
    const getDestination = () => location.state?.from?.pathname || '/dashboard'

    // Navigate when user appears in React state
    useEffect(() => {
        ...
        return (
            <div className="min-h-screen bg-black flex items-center justify-center">
                <div className="text-center">
                    <div className="w-16 h-16 border-t-2 border-primary rounded-full animate-spin mx-auto" />
        ...
        <div className="min-h-screen bg-black flex flex-col justify-center py-6 px-4 sm:py-12 sm:px-6 lg:px-8">
            ...
            >
                <div className="text-center">
                    ...
                    <h2 className="mt-6 text-2xl sm:text-3xl font-semibold text-white">Welcome back</h2>
                    <p className="mt-2 text-sm text-gray-400">Sign in to manage your links</p>
                </div>
                    ...
                    <div className="bg-gray-950/50 backdrop-blur-xl border border-gray-900/50 py-6 px-4 sm:py-8 sm:px-10 shadow-2xl rounded-lg">
                        ...
                        <form className="space-y-5 sm:space-y-6" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input
                                    ...
                                    className="mt-1 appearance-none block w-full px-3 py-2 border border-gray-700 rounded-md placeholder-gray-500 text-white bg-gray-900/50 focus:outline-none focus:ring-primary focus:border-primary text-sm sm:text-base"
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    <input
                                        ...
                                        className="appearance-none block w-full px-3 py-2 pr-10 border border-gray-700 rounded-md placeholder-gray-500 text-white bg-gray-900/50 focus:outline-none focus:ring-primary focus:border-primary text-sm sm:text-base"
                        ...
                        <div className="mt-6">
                            ...
                            <button
                                ...
                                type="button"
                                disabled={loading}
                                className="w-full flex justify-center items-center gap-3 px-4 py-2.5 sm:py-3 border border-gray-700 rounded-lg text-sm font-medium text-gray-300 bg-gray-900/50 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-primary transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {loading ? (
